...
class FreelancerEditAddressActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_freelancer_edit_address)
        citySpinner = findViewById(R.id.spinnerNewFreelancerCity)
        address1 = findViewById(R.id.freelancerNewAddress1EditText)
        address2 = findViewById(R.id.freelancerNewAddress2EditText)
        barangay = findViewById(R.id.freelancerNewBarangayEditText)
        ...
        buttonSave.setOnClickListener {
            insertAddress()
            val intent = Intent(this@FreelancerEditAddressActivity, FreelancerAccountFragment::class.java)
