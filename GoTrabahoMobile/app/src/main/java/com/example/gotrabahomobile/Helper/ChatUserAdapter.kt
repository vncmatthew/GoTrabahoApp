...
class ChatUserAdapter(private val context: Context, private val chatRoomList: ArrayList<ChatRoom>, private val serviceId: Int, private val serviceName: String?) :
